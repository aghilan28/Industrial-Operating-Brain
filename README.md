...
- **ackend/** — FastAPI platform, PostgreSQL persistence, RBAC, API Gateway, and MQTT IoT ingestion pipeline.
- **i-platform/** — GraphRAG, Knowledge Graph engine, computer vision pipelines (YOLO11 / RT-DETR), and predictive maintenance digital twins.
- **rontend/** — Next.js, React, and Tailwind CSS industrial monitoring dashboard.
